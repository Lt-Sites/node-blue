...
module.exports = function (RED) {
                ...
                for (var n = 0; n < msgs[m].length; n++) {
                    ...
                    if (msg !== null && msg !== undefined) {
                        if (
                            ...
                            node.error(
                                RED._("function.error.non-message-returned", {
                                    type: type,
                                })
                            );
                        }
    ...
    function FunctionNode(n) {
        ...
        this.func = n.func;
        var functionText =
            "module.exports = function(util, RED, __node__, context, flow, global, env, setTimeout, clearTimeout, setInterval, clearInterval) { " +
            "  return function(msg) { " +
        ...
        try {
            this.script = requireFromString(functionText)(
                sandbox.util,
                sandbox.RED,
                sandbox.__node__,
                sandbox.context,
        ...
        function handle(msg) {
            try {
                ...
                if (RED.settings.nodeRedContribUnsafeFunctionProfiling) {
                    profiling.count += 1;
                    profiling.total +=
                        (duration[0] * 1e9 + duration[1]) / 1000000;
                        ...
                        profiling.debounce = setInterval(function () {
                            ...
                            node.status({
                                ...
                                text:
                                    ...
                                    profiling.max +
                                    ", total: " +
                                    Math.round(profiling.total * 100) / 100 +
                                    ", count: " +
                                    profiling.count,
                            });
